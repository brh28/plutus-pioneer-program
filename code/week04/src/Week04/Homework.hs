...
payTrace x y = do
	h1 <- activateContractWallet (Wallet 1) payContract --playground does this automatically. h1 is a handle to refer to contract instance
...
-- should fail with Insufficent funds message
payTest2 :: IO ()
